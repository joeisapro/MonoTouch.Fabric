...
namespace MonoTouch.Fabric.DigitsKit
{
	...
	interface Digits
	{
		...
		void AuthenticateWithPhoneNumber (string phoneNumber, [NullAllowed]DGTAppearance appearance, [NullAllowed]UIViewController viewController, string title, DGTAuthenticationCompletion completion);
